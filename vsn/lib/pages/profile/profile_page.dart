...
class ProfilePage extends GetView<ProfileController> {
                    ...
                    flexibleSpace: FlexibleSpaceBar(
                      background: Column(
                        ...
                        children: [
                          ...
                          Text("Nguyen Hong Quang",style: Utils.getFont(fontSize: 14.0,fontWeight: FontWeight.w500,)),
  ...
  Widget customBox({String title, String value}){
    return Column(
      ...
      children: [
        Text(value,style: Utils.getFont(fontSize: 12.0,fontWeight: FontWeight.w800)),
        SizedBox(height: 5.0),
        Text(title,style: Utils.getFont(fontSize: 10.0,fontWeight: FontWeight.w400,color: Colors.grey)),
      ],
    );
  }
}